  ...
  export default function Dashboard() {
    ...
    return (
      <AdminLayout>
        {/* Welcome Section */}
        <div className="mb-8 p-6 bg-gradient-to-r from-purple-500 via-pink-400 to-red-400 rounded-3xl shadow-2xl flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6 relative overflow-hidden text-white">
          <div className="flex flex-col gap-3">
            ...
            <div className="mt-4 flex flex-col sm:flex-row gap-3">
              ...
              <a
                ...
                target="_blank"
                className="bg-gradient-to-tr from-blue-400 to-indigo-500 hover:from-blue-500 hover:to-indigo-600 text-white font-semibold px-5 py-3 rounded-lg shadow-lg hover:shadow-2xl hover:scale-105 transition-all duration-300 flex items-center justify-center gap-2"
              >
                <Download size={18} />
